...
window.AirSightDate = {
    // Get consistent current date across all pages
        ...
        const now = new Date();
        const localDate = new Date(now.getFullYear(), now.getMonth(), now.getDate()); // force midnight local time
    ...
    getCurrentYear: function() {
        return new Date(this.getCurrentDate()).getFullYear();
    },
    
    getCurrentMonth: function() {
        return new Date(this.getCurrentDate()).getMonth() + 1;
    }
};
...
function testDateConsistency() {
    ...
    console.log("Current Date:", window.AirSightDate.getCurrentDate());
    console.log("Tomorrow Date:", window.AirSightDate.getTomorrowDate());
    console.log("Current Year:", window.AirSightDate.getCurrentYear());
    console.log("Current Month:", window.AirSightDate.getCurrentMonth());
    
    // Test API calls with same date
    const testDate = window.AirSightDate.getCurrentDate();
